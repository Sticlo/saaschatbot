...
from app.services.message_service import parse_messages_upsert
from app.services.webhook_processor import process_evolution_webhook
from app.services.whatsapp_status import can_send_whatsapp, resolve_whatsapp_status
...
def test_webhook_rejects_wrong_instance(client: TestClient):
    ...
    from app.database import SessionLocal
    from app.models import WhatsAppSession, Message
...
@requires_db
@patch("app.services.whatsapp_service.evolution_client")
